...
d3.csv("./cloudcover_2022_selected.csv").then(function (data) {
    ...
    CloudByDay = d3.group(CloudByMonth.get("1"), d => d.Day)
    ...
    var average = d3.mean((CloudByMonth.get("1")), function (d) { return d.CloudAmount; })
    ...
    // const mostcloudy8 = d3.sum(CloudByDay.get("8"), function (d) {return d.CloudAmount;})
    // const mostcloudy9 = d3.sum(CloudByDay.get("9"), function (d) {return d.CloudAmount;})
    // const mostcloudy10 = d3.sum(CloudByDay.get("10"), function (d) {return d.CloudAmount;})
    // const mostcloudy11 = d3.sum(CloudByDay.get("11"), function (d) {return d.CloudAmount;})
    const mostcloudy12 = d3.sum(CloudByDay.get("12"), function (d) { return d.CloudAmount; })
    ...
    // const mostcloudy31 = d3.sum(CloudByDay.get("31"), function (d) {return d.CloudAmount;})
    ...
    var mostCloudy = d3.mean((CloudByDay.get("12")), function (d) { return d.CloudAmount; })
    ...
    var svg_stat_01 = d3.select("#number_A_1").append("text")

    svg_stat_01.append("text").text(average + " %")

    var svg_stat_02 = d3.select("#number_M_1").append("text")

    svg_stat_02.append("text").text("12th (Cloud of  " + mostCloudy + "%)")


    // Canvas for the chart: each svg is the canvas for one day. 

    var svg_01 = d3.select("#chart_01").append("svg").attr("width", width).attr("height", height + margin * 3).append("g")
        .attr('id', 'hover_01_1').attr("transform", "translate(" + 0 + "," + (margin + 30) + ")")

    var svg_02 = d3.select("#chart_01").append("svg").attr("width", width).attr("height", height + margin * 3).append("g")
        .attr('id', 'hover_01_2').attr("transform", "translate(" + 0 + "," + (margin + 30) + ")")

    var svg_03 = d3.select("#chart_01").append("svg").attr("width", width).attr("height", height + margin * 3).append("g")
        .attr('id', 'hover_01_3').attr("transform", "translate(" + 0 + "," + (margin + 30) + ")")

    var svg_04 = d3.select("#chart_01").append("svg").attr("width", width).attr("height", height + margin * 3).append("g")
        .attr('id', 'hover_01_4').attr("transform", "translate(" + 0 + "," + (margin + 30) + ")")

    var svg_05 = d3.select("#chart_01").append("svg").attr("width", width).attr("height", height + margin * 3).append("g")
        .attr('id', 'hover_01_5').attr("transform", "translate(" + 0 + "," + (margin + 30) + ")")

    var svg_06 = d3.select("#chart_01").append("svg").attr("width", width).attr("height", height + margin * 3).append("g")
        .attr('id', 'hover_01_6').attr("transform", "translate(" + 0 + "," + (margin + 30) + ")")

    var svg_07 = d3.select("#chart_01").append("svg").attr("width", width).attr("height", height + margin * 3).append("g")
        .attr('id', 'hover_01_7').attr("transform", "translate(" + 0 + "," + (margin + 30) + ")")

    var svg_08 = d3.select("#chart_01").append("svg").attr("width", width).attr("height", height + margin * 3).append("g")
        .attr('id', 'hover_01_8').attr("transform", "translate(" + 0 + "," + (margin + 30) + ")")

    var svg_09 = d3.select("#chart_01").append("svg").attr("width", width).attr("height", height + margin * 3).append("g")
        .attr('id', 'hover_01_9').attr("transform", "translate(" + 0 + "," + (margin + 30) + ")")

    var svg_10 = d3.select("#chart_01").append("svg").attr("width", width).attr("height", height + margin * 3).append("g")
        .attr('id', 'hover_01_10').attr("transform", "translate(" + 0 + "," + (margin + 30) + ")")

    var svg_11 = d3.select("#chart_01").append("svg").attr("width", width).attr("height", height + margin * 3).append("g")
        .attr('id', 'hover_01_11').attr("transform", "translate(" + 0 + "," + (margin + 30) + ")")

    var svg_12 = d3.select("#chart_01").append("svg").attr("width", width).attr("height", height + margin * 3).append("g")
        .attr('id', 'hover_01_12').attr("transform", "translate(" + 0 + "," + (margin + 30) + ")")

    var svg_13 = d3.select("#chart_01").append("svg").attr("width", width).attr("height", height + margin * 3).append("g")
        .attr('id', 'hover_01_13').attr("transform", "translate(" + 0 + "," + (margin + 30) + ")")

    var svg_14 = d3.select("#chart_01").append("svg").attr("width", width).attr("height", height + margin * 3).append("g")
        .attr('id', 'hover_01_14').attr("transform", "translate(" + 0 + "," + (margin + 30) + ")")

    var svg_15 = d3.select("#chart_01").append("svg").attr("width", width).attr("height", height + margin * 3).append("g")
        .attr('id', 'hover_01_15').attr("transform", "translate(" + 0 + "," + (margin + 30) + ")")

    var svg_16 = d3.select("#chart_01").append("svg").attr("width", width).attr("height", height + margin * 3).append("g")
        .attr('id', 'hover_01_16').attr("transform", "translate(" + 0 + "," + (margin + 30) + ")")

    var svg_17 = d3.select("#chart_01").append("svg").attr("width", width).attr("height", height + margin * 3).append("g")
        .attr('id', 'hover_01_17').attr("transform", "translate(" + 0 + "," + (margin + 30) + ")")

    var svg_18 = d3.select("#chart_01").append("svg").attr("width", width).attr("height", height + margin * 3).append("g")
        .attr('id', 'hover_01_18').attr("transform", "translate(" + 0 + "," + (margin + 30) + ")")

    var svg_19 = d3.select("#chart_01").append("svg").attr("width", width).attr("height", height + margin * 3).append("g")
        .attr('id', 'hover_01_19').attr("transform", "translate(" + 0 + "," + (margin + 30) + ")")

    var svg_20 = d3.select("#chart_01").append("svg").attr("width", width).attr("height", height + margin * 3).append("g")
        .attr('id', 'hover_01_20').attr("transform", "translate(" + 0 + "," + (margin + 30) + ")")

    var svg_21 = d3.select("#chart_01").append("svg").attr("width", width).attr("height", height + margin * 3).append("g")
        .attr('id', 'hover_01_21').attr("transform", "translate(" + 0 + "," + (margin + 30) + ")")

    var svg_22 = d3.select("#chart_01").append("svg").attr("width", width).attr("height", height + margin * 3).append("g")
        .attr('id', 'hover_01_22').attr("transform", "translate(" + 0 + "," + (margin + 30) + ")")

    var svg_23 = d3.select("#chart_01").append("svg").attr("width", width).attr("height", height + margin * 3).append("g")
        .attr('id', 'hover_01_23').attr("transform", "translate(" + 0 + "," + (margin + 30) + ")")

    var svg_24 = d3.select("#chart_01").append("svg").attr("width", width).attr("height", height + margin * 3).append("g")
        .attr('id', 'hover_01_24').attr("transform", "translate(" + 0 + "," + (margin + 30) + ")")

    var svg_25 = d3.select("#chart_01").append("svg").attr("width", width).attr("height", height + margin * 3).append("g")
        .attr('id', 'hover_01_25').attr("transform", "translate(" + 0 + "," + (margin + 30) + ")")

    var svg_26 = d3.select("#chart_01").append("svg").attr("width", width).attr("height", height + margin * 3).append("g")
        .attr('id', 'hover_01_26').attr("transform", "translate(" + 0 + "," + (margin + 30) + ")")

    var svg_27 = d3.select("#chart_01").append("svg").attr("width", width).attr("height", height + margin * 3).append("g")
        .attr('id', 'hover_01_27').attr("transform", "translate(" + 0 + "," + (margin + 30) + ")")

    var svg_28 = d3.select("#chart_01").append("svg").attr("width", width).attr("height", height + margin * 3).append("g")
        .attr('id', 'hover_01_28').attr("transform", "translate(" + 0 + "," + (margin + 30) + ")")

    var svg_29 = d3.select("#chart_01").append("svg").attr("width", width).attr("height", height + margin * 3).append("g")
        .attr('id', 'hover_01_29').attr("transform", "translate(" + 0 + "," + (margin + 30) + ")")

    var svg_30 = d3.select("#chart_01").append("svg").attr("width", width).attr("height", height + margin * 3).append("g")
        .attr('id', 'hover_01_30').attr("transform", "translate(" + 0 + "," + (margin + 30) + ")")

    var svg_31 = d3.select("#chart_01").append("svg").attr("width", width).attr("height", height + margin * 3).append("g")
        .attr('id', 'hover_01_31').attr("transform", "translate(" + 0 + "," + (margin + 30) + ")")

    var svg_32 = d3.select("#chart_01").append("svg").attr("width", width / 2).attr("height", height + margin * 3)
        // .append("g")
        // .attr('id', 'hover_01_32')
