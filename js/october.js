...
d3.csv("./cloudcover_2022_selected.csv").then(function (data) {
    ...
    CloudByDay = d3.group(CloudByMonth.get("10"), d => d.Day)
    ...
    var average = d3.mean((CloudByMonth.get("10")), function (d) { return d.CloudAmount; })
    ...
    var mostCloudy = d3.mean((CloudByDay.get("27")), function (d) { return d.CloudAmount; })
    ...
    var svg_stat_01 = d3.select("#number_A_10").append("text")

    svg_stat_01.append("text").text(average + " %")

    var svg_stat_02 = d3.select("#number_M_10").append("text")

    svg_stat_02.append("text").text("27th (Cloud of  " + mostCloudy + "%)")



    // Canvas for the chart: each svg is the canvas for one day. 

    var svg_01 = d3.select("#chart_10").append("svg").attr("width", width).attr("height", height + margin * 3).append("g")
        .attr('id', 'hover_10_1').attr("transform", "translate(" + 0 + "," + (margin + 30) + ")")

    var svg_02 = d3.select("#chart_10").append("svg").attr("width", width).attr("height", height + margin * 3).append("g")
        .attr('id', 'hover_10_2').attr("transform", "translate(" + 0 + "," + (margin + 30) + ")")

    var svg_03 = d3.select("#chart_10").append("svg").attr("width", width).attr("height", height + margin * 3).append("g")
        .attr('id', 'hover_10_3').attr("transform", "translate(" + 0 + "," + (margin + 30) + ")")

    var svg_04 = d3.select("#chart_10").append("svg").attr("width", width).attr("height", height + margin * 3).append("g")
        .attr('id', 'hover_10_4').attr("transform", "translate(" + 0 + "," + (margin + 30) + ")")

    var svg_05 = d3.select("#chart_10").append("svg").attr("width", width).attr("height", height + margin * 3).append("g")
        .attr('id', 'hover_10_5').attr("transform", "translate(" + 0 + "," + (margin + 30) + ")")

    var svg_06 = d3.select("#chart_10").append("svg").attr("width", width).attr("height", height + margin * 3).append("g")
        .attr('id', 'hover_10_6').attr("transform", "translate(" + 0 + "," + (margin + 30) + ")")

    var svg_07 = d3.select("#chart_10").append("svg").attr("width", width).attr("height", height + margin * 3).append("g")
        .attr('id', 'hover_10_7').attr("transform", "translate(" + 0 + "," + (margin + 30) + ")")

    var svg_08 = d3.select("#chart_10").append("svg").attr("width", width).attr("height", height + margin * 3).append("g")
        .attr('id', 'hover_10_8').attr("transform", "translate(" + 0 + "," + (margin + 30) + ")")

    var svg_09 = d3.select("#chart_10").append("svg").attr("width", width).attr("height", height + margin * 3).append("g")
        .attr('id', 'hover_10_9').attr("transform", "translate(" + 0 + "," + (margin + 30) + ")")

    var svg_10 = d3.select("#chart_10").append("svg").attr("width", width).attr("height", height + margin * 3).append("g")
        .attr('id', 'hover_10_10').attr("transform", "translate(" + 0 + "," + (margin + 30) + ")")

    var svg_11 = d3.select("#chart_10").append("svg").attr("width", width).attr("height", height + margin * 3).append("g")
        .attr('id', 'hover_10_11').attr("transform", "translate(" + 0 + "," + (margin + 30) + ")")

    var svg_12 = d3.select("#chart_10").append("svg").attr("width", width).attr("height", height + margin * 3).append("g")
        .attr('id', 'hover_10_12').attr("transform", "translate(" + 0 + "," + (margin + 30) + ")")

    var svg_13 = d3.select("#chart_10").append("svg").attr("width", width).attr("height", height + margin * 3).append("g")
        .attr('id', 'hover_10_13').attr("transform", "translate(" + 0 + "," + (margin + 30) + ")")

    var svg_14 = d3.select("#chart_10").append("svg").attr("width", width).attr("height", height + margin * 3).append("g")
        .attr('id', 'hover_10_14').attr("transform", "translate(" + 0 + "," + (margin + 30) + ")")

    var svg_15 = d3.select("#chart_10").append("svg").attr("width", width).attr("height", height + margin * 3).append("g")
        .attr('id', 'hover_10_15').attr("transform", "translate(" + 0 + "," + (margin + 30) + ")")

    var svg_16 = d3.select("#chart_10").append("svg").attr("width", width).attr("height", height + margin * 3).append("g")
        .attr('id', 'hover_10_16').attr("transform", "translate(" + 0 + "," + (margin + 30) + ")")

    var svg_17 = d3.select("#chart_10").append("svg").attr("width", width).attr("height", height + margin * 3).append("g")
        .attr('id', 'hover_10_17').attr("transform", "translate(" + 0 + "," + (margin + 30) + ")")

    var svg_18 = d3.select("#chart_10").append("svg").attr("width", width).attr("height", height + margin * 3).append("g")
        .attr('id', 'hover_10_18').attr("transform", "translate(" + 0 + "," + (margin + 30) + ")")

    var svg_19 = d3.select("#chart_10").append("svg").attr("width", width).attr("height", height + margin * 3).append("g")
        .attr('id', 'hover_10_19').attr("transform", "translate(" + 0 + "," + (margin + 30) + ")")

    var svg_20 = d3.select("#chart_10").append("svg").attr("width", width).attr("height", height + margin * 3).append("g")
        .attr('id', 'hover_10_20').attr("transform", "translate(" + 0 + "," + (margin + 30) + ")")

    var svg_21 = d3.select("#chart_10").append("svg").attr("width", width).attr("height", height + margin * 3).append("g")
        .attr('id', 'hover_10_21').attr("transform", "translate(" + 0 + "," + (margin + 30) + ")")

    var svg_22 = d3.select("#chart_10").append("svg").attr("width", width).attr("height", height + margin * 3).append("g")
        .attr('id', 'hover_10_22').attr("transform", "translate(" + 0 + "," + (margin + 30) + ")")

    var svg_23 = d3.select("#chart_10").append("svg").attr("width", width).attr("height", height + margin * 3).append("g")
        .attr('id', 'hover_10_23').attr("transform", "translate(" + 0 + "," + (margin + 30) + ")")

    var svg_24 = d3.select("#chart_10").append("svg").attr("width", width).attr("height", height + margin * 3).append("g")
        .attr('id', 'hover_10_24').attr("transform", "translate(" + 0 + "," + (margin + 30) + ")")

    var svg_25 = d3.select("#chart_10").append("svg").attr("width", width).attr("height", height + margin * 3).append("g")
        .attr('id', 'hover_10_25').attr("transform", "translate(" + 0 + "," + (margin + 30) + ")")

    var svg_26 = d3.select("#chart_10").append("svg").attr("width", width).attr("height", height + margin * 3).append("g")
        .attr('id', 'hover_10_26').attr("transform", "translate(" + 0 + "," + (margin + 30) + ")")

    var svg_27 = d3.select("#chart_10").append("svg").attr("width", width).attr("height", height + margin * 3).append("g")
        .attr('id', 'hover_10_27').attr("transform", "translate(" + 0 + "," + (margin + 30) + ")")

    var svg_28 = d3.select("#chart_10").append("svg").attr("width", width).attr("height", height + margin * 3).append("g")
        .attr('id', 'hover_10_28').attr("transform", "translate(" + 0 + "," + (margin + 30) + ")")

    var svg_29 = d3.select("#chart_10").append("svg").attr("width", width).attr("height", height + margin * 3).append("g")
        .attr('id', 'hover_10_29').attr("transform", "translate(" + 0 + "," + (margin + 30) + ")")

    var svg_30 = d3.select("#chart_10").append("svg").attr("width", width).attr("height", height + margin * 3).append("g")
        .attr('id', 'hover_10_30').attr("transform", "translate(" + 0 + "," + (margin + 30) + ")")

    var svg_31 = d3.select("#chart_10").append("svg").attr("width", width).attr("height", height + margin * 3).append("g")
        .attr('id', 'hover_10_31').attr("transform", "translate(" + 0 + "," + (margin + 30) + ")")

    var svg_32 = d3.select("#chart_10").append("svg").attr("width", width / 2).attr("height", height + margin * 3) // .append("g")
        // .attr('id', 'hover_10_32')
